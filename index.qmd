...
::: {.header-section style="background: linear-gradient(135deg, #95a5a6 0%, #95a5a6 100%); color: white; padding: 2rem 0; margin-bottom: 2rem; border-radius: 0.5rem;"}
::: {.logo-container style="display: flex; align-items: center; justify-content: space-between; width: 100%; margin-bottom: 1rem; padding: 0 2%;"}
![McNair Center](https://raw.githubusercontent.com/kerryback/portal-guide/main/docs/images/mcnair.jpg){.mcnair-logo style="border-radius: 10px; border: 2px solid white; background: white; padding: 2px; width: 20%; height: 80px; object-fit: contain;"}

# Rice Business Stock Market Data Portal {style="width: 45%; text-align: center; margin: 0; font-size: 1.8rem; color: white !important;"}

![Rice Business](https://raw.githubusercontent.com/kerryback/portal-guide/main/docs/images/rice-business.jpg){.rice-logo style="border-radius: 10px; border: 2px solid white; background: white; padding: 2px; width: 20%; height: 80px; object-fit: contain;"}
:::
:::
...
- [Data Portal](https://data-portal.rice-business.org)
- [Table Descriptions](tables.html)
- [Python API Tutorial](https://colab.research.google.com/github/kerryback/data-portal-notebook/blob/main/Rice_Business_Data_Example.ipynb)
